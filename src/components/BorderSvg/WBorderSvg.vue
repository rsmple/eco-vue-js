<template>
  ...
  >
    <rect
      ...
      :class="rectClass"
      class="
        size-[calc(100%-var(--border-svg-padding)*2)]
        [rx:var(--w-border-svg-rounded)]
        [stroke-width:var(--w-border-svg-stroke-width,2px)]
        [x:var(--border-svg-padding)]
        [y:var(--border-svg-padding)]
      "
    >
      <slot />
    </rect>
